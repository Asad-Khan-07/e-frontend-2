  ...
  return (
    <Link to={`/products/${product.id}`} className="group block">
      <div className={`relative overflow-hidden rounded-2xl ${isLight ? 'hover:shadow-[0_0_15px_5px_#62748e]' : 'hover:shadow-[0_0_15px_5px_#fcd34d]'}  bg-white/5 border border-white/10 hover:border-amber-400/40 transition-all duration-500 hover:-translate-y-1`}>
        ...
        <div className="p-4 text-start transition-all duration-300 translate-y-30 group-hover:translate-y-0 ">
    ...
    <main>
      ...
      <section className="py-20 max-w-7xl mx-auto px-6">
        ...
        <div className="flex flex-col items-center justify-center mb-12">
          <div>
            <p className="text-amber-400 text-lg font-medium tracking-widest uppercase mb-2">Trending Now</p>
            <h1 className="text-[50px] ">Featured Categories</h1>
          </div>
          <Link to="/products" className="group text-white/50 hover:text-amber-400 text-sm font-medium flex items-center gap-1 transition-colors">
            View All
            <svg className="w-4 h-4 group-hover:translate-x-1 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <section className="py-20 max-w-full px-6 ">
        <div className="flex items-center flex-col justify-between mb-12 pb-4">
          <div >
            <h1 className="text-4xl font-black text-center">Categories</h1>
          </div>
