    ...
    <div className="p-6">
      ...
      <div className="bg-white/5 border border-white/10 rounded-2xl p-6 mb-6">
        ...
        <button
          ...
          className="mt-4 bg-amber-400 hover:bg-amber-300 shadow-2xl shadow-amber-400 hover:shadow-amber-300 disabled:opacity-50 text-black font-bold px-6 py-2.5 rounded-xl text-sm transition-colors flex items-center gap-1.5"
        >
      ...
      {loading ? (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          {categories.map(cat => (
            <div key={cat._id} className={`bg-white/5 border shadow-2xl ${isLight ? 'shadow-slate-300' : 'shadow-amber-300'} hover:scale-x-105 border-white/10 rounded-2xl p-5 flex items-center justify-between hover:border-white/20 transition-all`}>
              ...
              <button
                ...
                className="bg-white/5 hover:bg-red-500/10 border border-white/10 hover:border-red-500/20 text-white/40 hover:text-red-400 w-8 h-8 rounded-lg flex items-center justify-center transition-all"
              >
                <X size={15} />
              </button>
            </div>
